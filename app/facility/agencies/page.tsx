...
export default function FacilityAgenciesPage() {
    ...
    <div className="space-y-10">
      <section className="animate-rise">
        ...
        <p className="mt-2 max-w-xl text-ink-muted">
          Search the directory by city or ZIP, open profiles, and request
          connections. Coverage requests will go only to agencies you are
          connected with.
        </p>
      </section>
        ...
        {!connections.isLoading && (connections.data?.length ?? 0) === 0 ? (
          <div className="rounded-xl border border-dashed border-border bg-white p-8 text-center">
            ...
            <p className="mt-1 text-sm text-ink-muted">
              Use the search above, open a profile, and send a connection
              request.
            </p>
          </div>
        ) : null}
