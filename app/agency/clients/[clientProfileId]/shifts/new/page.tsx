...
import { createAgencyClientShift } from "@/lib/api";
import {
  ShiftForm,
...
function AgencyNewShiftInner() {
  ...
  async function onSubmit(values: AgencyShiftFormValues) {
    try {
      const created = await createAgencyClientShift(clientProfileId, {
    ...
    <div className="mx-auto max-w-2xl space-y-5">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-ink-muted">
          Posted on the home&apos;s calendar using their service address. Assign
          your caregivers from the Shifts page after creating.
        </p>
      </div>
...
export default function AgencyNewClientShiftPage() {
  return (
